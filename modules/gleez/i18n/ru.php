...
return array(
	...
	'Add Category for %vocab' => 'Новая категория для группы %vocab',
	...
	'Add New Term' => 'Добавить новую категорию',
	'Add new category groups to your site, edit and reorganize existing categories.' => 'Добавляйте новые группы категорий на ваш сайт, редактируйте и реорганизуйте существующие группы.',
    ...
    'An error occurred while deleting alias %path' => 'Произошла ошибка при удалении синонима %path',
	'An error occurred deleting blog %post' => 'Произошла ошибка при удалении блога %post',
	'An error occurred deleting category %term.' => 'Произошла ошибка при удалении категории %term',
	'An error occurred deleting category group %term' => 'Произошла ошибка при удалении группы категорий %term',
    'An error occurred while deleting comment %post' => 'Произошла ошибка при удалении комментария %post',
	'An error occurred deleting menu %menu: :message' => 'Произошла ошибка при удалении меню %menu: :message',
    ...
    'An error occurred while deleting tag %tag' => 'Произошла ошибка при удалении тега %tag',
	...
	'Categories are needed for grouping content. Categories are grouped by category groups. For example, a category group called "Fruit" would contain the categories "Apple" and "Banana".' => 'Категории нужны для группировки содержимого сайта. Категории сгруппированы по группам категорий. Например, группа категорий называющаяся "Фрукты" будет содержать категории "Яблоко" и "Банан".',
	'Categories of Group %vocab' => 'Категории группы %vocab',
	'Category' => 'Категория',
	'Category %name deleted successful!' => 'Категория %name успешно удалена!',
	'Category %name saved successful!' => 'Категория %name успешно сохранена!',
	"Category doesn't exists!" => 'Категория не найдена!',
	'Category Groups' => 'Группы категорий',
	'Category Group %name saved successful!' => 'Группа категорий успешно сохранена',
	'Category Group %name deleted successful!' => 'Группа категорий %name успешно удалена!',
	"Category Group doesn't exists!" => 'Группа категорий не найдена!',
	'Cancel' => 'Отмена',
	...
	'Delete Category Group :title' => 'Удаление группы категорий :title',
	'Delete the selected comments' => 'Удалить выбранные комментарии',
	'Deleting Category %name' => 'Удаление категории %name',
	'Demote from front page' => 'Убрать с главной страницы',
	'Description' => 'Описание',
	'Description for search engines' => 'Описание для поисковых систем',
	'Description not visible by default, however some themes may show it. The main purpose of this description - to inform administrator about the group.' => 'Описание по умолчанию не отображается, однако некоторые темы могут его показывать. Основная цель этого описания - информировать администратора о группе.',
	'Did something go wrong? Try the :github.' => 'Что-то пошло не так? Возможно проблема уже решена. Если это не так сообщите нам: :github.',
	...
	'Edit Category Group %name' => 'Правка группы категорий %name',
	...
	'Footer' => 'Подвал',
	'For what type of content you intend to use categories from this group?' => 'Для какого типа содержимого вы собираетесь использовать категории из этой группы?',
	'Forum' => 'Форум',
	'Friday' => 'Пятница',
	...
	'Gleez Environment' => 'Рабочее окружение Gleez',
	'Gleez CMS core application' => 'Базовое приложение Gleez CMS',
	'Gleez CMS requires a MySQL database, but PHP doesn\'t have the :mysqli extension.' => 'Gleez CMS требуется поддержка базы данных MySQL, но расширение PHP-:mysqli не обнаружено.',
	...
	'Group name and description' => 'Название группы и описание',
	// H
	...
	// N
	'Name' => 'Название',
	"Name of the group can't be empty" => 'Название группы не может быть пустым',
	...
	'New Category Group %name saved successful!' => 'Новая группа категорий %name успешно сохранена!',
	'Newer' => 'Новые',
	'Next' => 'Далее',
	'No' => 'Нет',
	...
	'No Terms!' => 'Категории не обнаружены!',
	...
	'Operations' => 'Операции',
	'Order' => 'Порядок',
	'Order of the categories could not be saved.' => 'Порядок категорий не может быть сохранен.',
	'Order of the categories has been saved.' => 'Порядок категорий успешно сохранён.',
	'OS Type' => 'Тип ОС',
	'Other' => 'Другое',
	'outdated' => 'устаревший',
	// P
	...
	'Server Signature' => 'Сигнатура сервера',
	'Server Software' => 'ПО сервера',
	'Show' => 'Показать',
	...
	'The top of the main content' => 'Верх основного содержимого страницы',
	...
	'There are no Categories that have been created for %vocab.' => 'Нет ни одной категории, созданой для группы %vocab.',
	...
	'There are no Terms.' => 'Пока нет категорий.',
	...
	'Your Name' => 'Ваше имя',
	// Z
	'Zend Engine Version' => 'Версия Zend Engine',
