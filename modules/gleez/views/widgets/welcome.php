...
<ul>
	<li>
        <?php _e('General Settings &mdash; choose your :settings_url.', [':settings_url' => HTML::anchor('admin/settings', __('settings'))]); ?>
	</li>

	<li>
        <?php _e('Customize &mdash; :modules_url to add cool features!', [':modules_url' => HTML::anchor('admin/modules', __('modules'))]); ?>
	</li>
</ul>
