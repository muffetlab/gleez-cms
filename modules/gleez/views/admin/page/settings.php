...
<?php echo Form::open($action, array('class'=>'page-settings-form form form-horizontal')) ?>
	...
	<div class="form-group">
		...
		<div class="controls set-check">
			<div class="checkbox">
				<?php echo Form::label('use_excerpt',       Form::checkbox('use_excerpt', TRUE, $use_excerpt).__('Enable excerpt'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_comment',       Form::checkbox('use_comment', TRUE, $use_comment).__('Enable comments'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_authors',       Form::checkbox('use_authors', TRUE, $use_authors).__('Enable authors'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_captcha',       Form::checkbox('use_captcha', TRUE, $use_captcha).__('Enable captcha'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_category',      Form::checkbox('use_category', TRUE, $use_category).__('Enable Category'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_tags',          Form::checkbox('use_tags', TRUE, $use_tags).__('Enable tag cloud'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_submitted',     Form::checkbox('use_submitted', TRUE, $use_submitted).__('Show Submitted Info'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('use_cache',         Form::checkbox('use_cache', TRUE, $use_cache).__('Enable Page Cache'));?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('comment_anonymous', Form::checkbox('comment_anonymous', TRUE, $comment_anonymous).__('Allow anonymous commenting (with contact information)'));?>
			</div>
		</div>
	</div>
	...
	<div class="form-group <?php echo isset($errors['comment_default_mode']) ? 'has-error': ''; ?>">
		...
		<div class="controls col-sm-4">
			<div class="radio">
				<?php echo Form::label('comment_default_mode', Form::radio('comment_default_mode', 1, $mode1).__('Flat list &mdash; collapsed')) ?>
			</div>
			
			<div class="radio">
				<?php echo Form::label('comment_default_mode', Form::radio('comment_default_mode', 2, $mode2).__('Flat list &mdash; expanded')) ?>
			</div>
			
			<div class="radio">
				<?php echo Form::label('comment_default_mode', Form::radio('comment_default_mode', 3, $mode3).__('Threaded list &mdash; collapsed')) ?>
			</div>
			
			<div class="radio">
				<?php echo Form::label('comment_default_mode', Form::radio('comment_default_mode', 4, $mode4).__('Threaded list &mdash; expanded')) ?>
			</div>
		</div>
	</div>
