...
2. **There are 2 kinds of Routes**
   ...
   **You declare a Route for the admin backend like this:**
   ...
   That means you can hide your admin backend to a different URI section like mysecretadminsection. You can then access your admin section like this http://www.mydomain.com/mysecretadminsection instead of http://www.mydomain.com/admin.
