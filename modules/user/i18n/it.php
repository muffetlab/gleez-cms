...
return array(
  // :
	...
	// A
	'A request to reset the password for your account has been made at !site.' => 'E\' stata effettuata una richiesta di reset della password del tuo profilosul !site.',
	'About' => 'Riguardo a',
	'Account %title created successful!' => 'Il profilo %title &#269; stato creato correttamente!',
	'Activity' => 'Attività',
	...
	'Change own username' => 'Cambia il tuo username',
	'Change Password' => 'Cambia password',
	'Change your avatar' => 'Cambia il tuo avatar',
	'Close' => 'Chiudi',
	...
	'Email' => 'Email',
	// F
	'Fast, safe & secure way!' => 'Modalità veloce e sicura!',
	'Female' => 'Femmina',
	'Fill in the information below to register' => 'Per registrarsi, compilare il modulo di registrazione qui sotto',
	'First Visit' => 'Prima visita',
	'Forgot Password?' => 'Password dimenticata?',
	// G
	'Gender' => 'Genere',
	'Gleez CMS allows users to register, login, log out, maintain user profiles, etc. Users of the site may not use their own names to post content until they have signed up for a user account.' => 'Gleez CMS permette agli utenti di registrarsi, accedere e disconnettersi, mantenere profili utente ecc... Gli utenti del sito non saranno in grado di usare i propri nomi per pubblicare contenuti finchè non avranno registrato un account utente.',
	'Gleez users and group management' => 'Utenti Gleez e gestione di gruppo',
	'Go to' => 'Vai a',
	// H
	...
	'Profile %title' => 'Profilo %title',
	'Public' => 'Pubblico',
	// Q
	// R
	'Register new account' => 'Registra un nuovo profilo',
	...
	'Visits' => 'Visite',
	// W
	'Warning! Give to trusted roles only; this permission has security implications.' => 'Attenzione! Concedere solo a ruoli attendibili, questi poteri hanno implicazioni per la sicurezza.',
	'Welcome to Gleez!' => 'Benvenuto in Gleez!',
	'Welcome, %title!' => 'Benvenuto, %title!',
	'Will be private' => 'Sar&agrave; privato',
	'Will be public' => 'Sar&agrave; pubblico',
	// X
	// Y
