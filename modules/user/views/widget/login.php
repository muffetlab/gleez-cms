...
<?php echo Form::open($action, ['role' => 'form']); ?>
	...
	<div class="form-group <?php echo isset($errors['name']) ? 'has-error': ''; ?>">
		...
		<div class="input-group">
            ...
            <?php echo Form::input('name', $post->name, ['class' => 'form-control', 'placeholder' => __('Email')]); ?>
		</div>
	</div>
	...
	<div class="form-group">
        <?php echo Form::submit('login', __('Sign In'), ['class' => 'btn btn-primary btn-block']); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php if ($register): ?>
			<div class="col-sm-4">
                <?php echo HTML::anchor('user/register', __('Register'), ['class' => 'pull-right']); ?>
			</div>
		<?php endif; ?>
	</div>
		...
		<div class="form-group">
			...
			<div class="btn-group">
				<?php
					...
					{
                        echo HTML::anchor($provider['url'], '<i class="fab fa-lg fa-' . $provider['icon'] . '"></i>', [
