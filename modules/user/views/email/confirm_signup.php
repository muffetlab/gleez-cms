...
<?php echo __('Thank you for registering at :site.', [
        ':site' => Kohana::$config->load('site')->get('site_name', 'Gleez CMS')
    ]) . PHP_EOL ?>

<?php echo __('IMPORTANT:') . PHP_EOL ?>
<?php echo __('For full site access, you will need to click on this link or copy and paste it in your browser: :url', [
        ':url' => PHP_EOL . $url
    ]) . PHP_EOL . PHP_EOL ?>
